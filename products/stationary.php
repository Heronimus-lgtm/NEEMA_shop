...
<head>
  ...
  <!-- Title Tag  -->
    <title>Stationary | NEEMA WERU</title>
  <!-- Favicon -->
  ...
  <header class="header shop">
          ...
          <div class="col-lg-2 col-md-3 col-12">
            <div class="right-bar">
              ...
              <div class="sinlge-bar">
                <a href="tel:+254718682319" class="single-icon"><i class="fa fa-phone" aria-hidden="true"></i> </a>
              </div>
              <div class="sinlge-bar">
                <a href="mailto:info@neemaweru.com" class="single-icon"><i class="fa fa-envelope" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="header-inner">
      ...
      <ul class="nav main-menu menu navbar-nav">
        ...
        <li><a href="#">OTHER PRODUCTS<i class="ti-angle-down"></i></a>
          <ul class="dropdown">
...
$sql = "SELECT * FROM allproductsforsale WHERE productcategory='stationary' ORDER BY productid DESC";
