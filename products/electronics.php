...
<head>
  ...
  <!-- Title Tag  -->
    <title>Electronics| NEEMA WERU</title>
  <!-- Favicon -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-2 col-md-2 col-12">
            <!-- Logo -->
            <div class="logo">
              <a href="../home.php"><img src="../logo.png" alt="logo" height="70" width="70"></a>
            </div>
            <!--/ End Logo -->
            <!-- Search Form -->
...
$sql = "SELECT * FROM allproductsforsale WHERE productcategory='electronic' ORDER BY productid DESC";
